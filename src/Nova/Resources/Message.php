...
class Message extends Resource
{
    ...
    public function fields(NovaRequest $request): array
    {
        return [
            ...
            Text::make('Receiver Id', 'receiver_id')->hideFromIndex(),
            Text::make('Sender Type', 'sender_type')->hideFromIndex(),
            Text::make('Sender Id', 'sender_id')->hideFromIndex(),
            Text::make('Company Id', 'company_id')->sortable(),
            Number::make('Message Type Id', 'message_type_id')->sortable(),
            Text::make('Messagable Type', 'messagable_type')->hideFromIndex(),
            Text::make('Messagable Id', 'messagable_id')->hideFromIndex(),
            ...
            DateTime::make('Delivered At', 'delivered_at')->nullable()->sortable(),
            DateTime::make('Bounced At', 'bounced_at')->nullable()->sortable(),
    ...
    public function filters(NovaRequest $request): array
    {
        return [
            ...
            new DateFilter('delivered_at', null),
            new DateFilter('bounced_at', null),
