...
class SesSnsDashboardController extends Controller
{
    public function __invoke()
    {
        ...
        return view('messenger::ses-sns-dashboard', [
            ...
            'event_transport' => (string) config('messenger.tracking.event_transport', 'sns_http'),
            'app_config' => [
                ...
                'sns_verify_signature' => (bool) config('messenger.tracking.sns.verify_signature', false),
                'sqs_queue_name' => (string) config('messenger.ses_sns.sqs.queue_name', ''),
                'sqs_dlq_name' => (string) config('messenger.ses_sns.sqs.dlq_name', ''),
                'sqs_raw_message_delivery' => (bool) config('messenger.ses_sns.sqs.raw_message_delivery', false),
